...
# -*- coding: utf-8 -*-
#
# ipydat documentation build configuration file
#
...
project = 'ipydat'
copyright = '2018, Vidar Tonaas Fauske, Sebastian Koch'
...
_version_py = os.path.join(repo, 'ipydat', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipydat.tex', 'ipydat Documentation',
     'Vidar Tonaas Fauske, Sebastian Koch', 'manual'),
]
